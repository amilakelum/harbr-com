      ...
      <div className="relative">
              ...
              <div className="mt-6 hidden sm:block">
                <Reveal delay={0.25} className="mt-10">
                  <form
                    ...
                    className="flex flex-col sm:flex-row items-center gap-4 sm:gap-x-4 bg-white p-2 rounded-2xl shadow-sm max-w-lg"
                  >
                    <input
                      type="email"
                      value={email}
        ...
        <div className="sm:hidden mt-6 bg-zinc-50 p-6 rounded-2xl shadow-sm border border-zinc-100 ">
          <Reveal delay={0.25} className="mt-10">
            <form
              onSubmit={handleSubmit}
              className="flex flex-col sm:flex-row items-center gap-4 sm:gap-x-4 bg-white p-2 rounded-2xl shadow-sm mx-auto max-w-sm"
            >
              <input
                type="email"
                value={email}
