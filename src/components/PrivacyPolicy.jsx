        ...
        <Reveal slideY={0} delay={0.4} className="mt-16">
          ...
          <section className="mb-12">
            ...
            <ul className="list-none space-y-4 text-zinc-600">
              ...
              <li><strong>Business</strong> refers to the Company or Operator as the legal entity that collects Consumers' personal information and determines the purposes and means of the processing of Consumers' personal information, or on behalf of which such information is collected and that alone, or jointly with others, determines the purposes and means of the processing of consumers' personal information.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HARBR PTY LTD, SUITE 302 13/15 WENTWORTH AVE, SYDNEY NSW, 2000, ABN/ACN: 15 685 512 154. For the purpose of the GDPR, the Company or Operator is the Data Controller.</li>
              <li><strong>Consumer</strong> refers to You.</li>
              <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
              <li><strong>Country</strong> refers to AUSTRALIA.</li>
              <li><strong>Data Controller</strong>, for the purposes of the GDPR (General Data Protection Regulation), refers to the Company or Operator as the legal person which alone or jointly with others determines the purposes and means of the processing of Personal Data.</li>
              ...
              <li><strong>Operator</strong> (referred to as either "the Operator", "We", "Us" or "Our" in this Agreement) refers to HARBR MARINE PTY LTD. For the purpose of the GDPR, the Company or Operator is the Data Controller.</li>
              ...
              <li><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of the Company or Operator. It refers to third-party companies or individuals employed by the Company or Operator to facilitate the Service, to provide the Service on behalf of the Company or Operator, to perform services related to the Service or to assist the Company or Operator in analyzing how the Service is used. For the purpose of the GDPR, Service Providers are considered Data Processors.</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-zinc-600 mb-4">If you have any questions about this Privacy Policy, You can contact us:</p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">3 - Collecting and Using Your Personal Data</h2>
            
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.1 - Types of Data Collected</h3>
            
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.1.1 - Personal Data</h4>
            <p className="text-zinc-600 mb-4">While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.1.2 - Usage Data</h4>
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.1.3 - Information from Third-Party Social Media Services</h4>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.1.4 - Tracking Technologies and Cookies</h4>
            <div className="space-y-4 text-zinc-600 mb-8">
              ...
              <ul className="list-disc pl-6 space-y-4">
                ...
                <li>
                  ...
                  <ul className="list-disc pl-6 mt-2 space-y-2">
                    ...
                    <li>Administered by: Us</li>
                    <li>Purpose: These Cookies identify if users have accepted the use of cookies on the Application or Website.</li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="list-disc pl-6 mt-2 space-y-2">
                    <li>Type: Persistent Cookies</li>
                    <li>Administered by: Us</li>
                    <li>Purpose: These Cookies allow us to remember choices You make when You use the Application or Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Application or Website.</li>
                  </ul>
                </li>
                <li>
            ...
            <p className="text-zinc-600 mt-4 mb-4">We may share Your personal information in the following situations:</p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-600 pb-6">
              ...
              <li>For business transfers: We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company or Operator assets, financing, or acquisition of all or a portion of Our business to another company.</li>
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.3 - Retention of Your Personal Data</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.4 - Transfer of Your Personal Data</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.5 - Delete Your Personal Data</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.6 - Disclosure of Your Personal Data</h3>
            
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.6.1 - Business Transactions</h4>
            <p className="text-zinc-600 mb-8">
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.6.2 - Law enforcement</h4>
            <p className="text-zinc-600 mb-8">
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">3.6.3 - Other legal requirements</h4>
            <p className="text-zinc-600 mb-4">The Company or Operator may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-600 pb-6">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">3.7 - Security of Your Personal Data</h3>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">4 - Detailed Information on the Processing of Your Personal Data</h2>
            <p className="text-zinc-600 mb-4">The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
            
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">4.1 - Analytics</h3>
            <p className="text-zinc-600 mb-4">We may use third-party Service providers to monitor and analyze the use of our Service. They may include, but are not limited to:</p>
            
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">Google Analytics</h4>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <p className="text-zinc-600 mb-8">We may share information, such as hashed email addresses (if available) or other online identifiers collected on Our Service with these third-party vendors. This allows Our third-party vendors to recognize and deliver You ads across devices and browsers. To read more about the technologies used by these third-party vendors and their cross-device capabilities please refer to the Privacy Policy of each vendor listed below.</p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">5 - Links to Other Websites</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">6 - GDPR Privacy</h2>
            
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">6.1 - Legal Basis for Processing Personal Data under GDPR</h3>
            <p className="text-zinc-600 mb-4">We may process Personal Data under the following conditions:</p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-600 mb-8">
              <li><strong>Consent:</strong> You have given Your consent for processing Personal Data for one or more specific purposes.</li>
              <li><strong>Performance of a contract:</strong> Provision of Personal Data is necessary for the performance of an agreement with You and/or for any pre-contractual obligations thereof.</li>
              <li><strong>Legal obligations:</strong> Processing Personal Data is necessary for compliance with a legal obligation to which the Company or Operator is subject.</li>
              <li><strong>Vital interests:</strong> Processing Personal Data is necessary in order to protect Your vital interests or of another natural person.</li>
              <li><strong>Public interests:</strong> Processing Personal Data is related to a task that is carried out in the public interest or in the exercise of official authority vested in the Company or Operator.</li>
              <li><strong>Legitimate interests:</strong> Processing Personal Data is necessary for the purposes of the legitimate interests pursued by the Company or Operator.</li>
            </ul>
            <p className="text-zinc-600 mb-8">In any case, the Company or Operator will gladly help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Data is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</p>

            <h3 className="text-xl font-semibold text-zinc-800 mb-4">6.2 - Your Rights under the GDPR</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">6.3 - Exercising of Your GDPR Data Protection Rights</h3>
            <div className="space-y-4 text-zinc-600">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">7 - CCPA, CalOPPA, and California Privacy Rights</h2>
            <p className="text-zinc-600 mb-8">This privacy notice section for California residents supplements the information contained in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in the State of California.</p>
            
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.1 - Categories of Personal Information Collected</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <div className="space-y-6 text-zinc-600 mb-8">
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category A: Identifiers.</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)).</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category C: Protected classification characteristics under California or federal law.</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category D: Commercial information.</h4>
                <p className="mb-2">Examples: Records and history of products or services purchased or considered.</p>
                <p><strong>Collected: Yes.</strong></p>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category E: Biometric information.</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category F: Internet or other similar network activity.</h4>
                <p className="mb-2">Examples: Interaction with our Service or advertisement.</p>
                <p><strong>Collected: Yes.</strong></p>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category G: Geolocation data.</h4>
                <p className="mb-2">Examples: Approximate physical location.</p>
                <p><strong>Collected: No.</strong></p>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category H: Sensory data.</h4>
                <p className="mb-2">Examples: Audio, electronic, visual, thermal, olfactory, or similar information.</p>
                <p><strong>Collected: No.</strong></p>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category I: Professional or employment-related information.</h4>
                <p className="mb-2">Examples: Current or past job history or performance evaluations.</p>
                <p><strong>Collected: No.</strong></p>
              </div>

              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category J: Non-public education information (per the Family Educational Rights and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)).</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-zinc-800 mb-2">Category K: Inferences drawn from other personal information.</h4>
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.2 - Sources of Personal Information</h3>
            <p className="text-zinc-600 mb-4">We obtain the categories of personal information listed above from the following categories of sources:</p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.3 - Use of Personal Information for Business Purposes or Commercial Purposes</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.4 - Disclosure of Personal Information for Business Purposes or Commercial Purposes</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.5 - Sale of Personal Information</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.6 - Share of Personal Information</h3>
            <p className="text-zinc-600 mb-4">We may share Your personal information identified in the above categories with the following categories of third parties:</p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.7 - Sale of Personal Information of Minors Under 16 Years of Age</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.8 - Your Rights under the CCPA</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
              ...
              <ul className="list-disc pl-6 space-y-4">
                ...
                <li>
                  ...
                  <p className="mt-2">If we sold Your personal information or disclosed Your personal information for a business purpose, We will disclose to You:</p>
                  <ul className="list-disc pl-6 mt-2 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.9 - Exercising Your CCPA Data Protection Rights</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.10 - Do Not Sell My Personal Information</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">7.10.1 - Website</h4>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h4 className="text-lg font-semibold text-zinc-800 mb-4">7.10.2 - Mobile Devices</h4>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.11 - "Do Not Track" Policy as Required by California Online Privacy Protection Act (CalOPPA)</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
              <p>Our Service does not respond to Do Not Track signals.</p>
              <p>However, some third party websites do keep track of Your browsing activities. If You are visiting such websites, You can set Your preferences in Your web browser to inform websites that You do not want to be tracked. You can enable or disable DNT by visiting the preferences or settings page of Your web browser.</p>
            </div>

            <h3 className="text-xl font-semibold text-zinc-800 mb-4">7.12 - Your California Privacy Rights (California's Shine the Light law)</h3>
            <div className="space-y-4 text-zinc-600">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">8 - Children's and Minor Users Privacy Rights</h2>
            
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">8.1 - General Privacy Rights for Children</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
            ...
            <h3 className="text-xl font-semibold text-zinc-800 mb-4">8.2 - California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h3>
            <div className="space-y-4 text-zinc-600 mb-8">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-zinc-900 mb-6">9 - Changes to this Privacy Policy</h2>
            <div className="space-y-4 text-zinc-600">
