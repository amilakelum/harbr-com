...
export default function BlogPost() {
  ...
  return (
    <article className="min-h-screen bg-white">
      {/* Header Section */}
      <div className="bg-[#054ada] px-6 py-16 lg:py-24 lg:px-8">
        <div className="max-w-4xl mx-auto px-6 py-8 text-center">
          <Reveal delay={0.1}>
            {/* Category Tag */}
            <div className="mb-6">
              <span
                className="inline-flex items-center text-xs font-bold uppercase tracking-wide text-white"
            ...
            {/* Title */}
            <h1
              className="text-[32px] sm:text-[40px] lg:text-[48px] leading-[1.1] tracking-[-0.02em] font-bold mb-6 text-white"
            ...
            <div className="text-center text-sm text-white mb-8">
              <div className="flex items-center justify-center mb-2">
                ...
                <span
                  className="font-medium text-white mx-1 underline decoration-white"
                  style={{ fontSize: "16px", lineHeight: "22px" }}
                >
                  Sarah Johnson
                </span>
                ...
                <span
                  className="font-medium text-white mx-1 underline"
                  style={{ fontSize: "16px", lineHeight: "22px" }}
                >
                  Akila
                </span>
