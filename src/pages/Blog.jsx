...
export default function Blog() {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative isolate px-6 py-24 lg:py-32 lg:px-8 bg-[#054ada] ">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {categories.map((category) => (
                  <button
                    ...
                    style={
                      selectedCategory === category
                        ? { backgroundColor: "#054ada", color: "#fff" }
                        : {
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.backgroundColor = "#054ada";
                    ...
                    onMouseLeave={(e) => {
                      if (selectedCategory === category) {
                        ...
                        e.target.style.backgroundColor = "rgba(5, 74, 218, .1)";
                        e.target.style.color = "#054ada";
                      }
                    }}
                  >
                    {category}
            ...
            {currentPosts.map((post, index) => (
              <Reveal key={post.id} delay={0.05 * (index + 1)}>
                ...
                >
                  ...
                  <div className="mb-3">
                    <span
                      className="inline-flex items-center py-1 rounded text-xs font-bold uppercase tracking-wide"
                      style={{
                        color: "#000",
                      }}
                    >
                  ...
                  {/* Title */}
                  <h2
                    className="font-bold text-[#054ada] mb-3 group-hover:transition-colors duration-200 leading-tight group-hover:text-[#f80]"
