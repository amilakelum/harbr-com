...
export default function Pricing() {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-zinc-50">
      <div
        id="pricing"
        className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <Reveal delay={0.1}>
            <h1 className="text-[38px] sm:text-[46px] leading-[1.1] tracking-[-0.02em] font-normal text-center mb-6 sm:mb-8">
              Pricing
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
              <p className="text-pretty text-zinc-600 text-base sm:text-lg/8">
                Subscriptions are priced according to how many berths there are
                in your marina. SMS messages sent from Harbr cost an additional
                10¢ each. Emails are free.
              </p>
            </div>
          </Reveal>
          ...
          {/* <Reveal delay={0.25}>
            <div className="bg-[#5371FF] text-white rounded-2xl p-6 sm:p-8 mb-10 sm:mb-16 text-center mt-10 sm:mt-16">
              ...
              <motion.button
                ...
                onClick={() => {
                  window.open(
                    "mailto:chris@harbrapp.com?subject=50%25%20Discount%20Offer",
                    "_blank"
                  );
                }}
              >
          ...
          <div className="w-full mx-auto">
            ...
            <div className="text-right text-zinc-600 mb-8">
            ...
            <div className="flex-1 md:pl-8 md:ml-8 mb-5 pb-5">
              ...
              <ul className="space-y-1 text-base text-zinc-700">
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>Every Harbr
                  feature
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>100% free
                  support
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>Unlimited
                  customers
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>Unlimited
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>24/7
                  Monitoring
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2 mt-1">✓</span>Constant
                  updates
                </li>
                <li className="flex items-start">
            ...
            <div className="flex-1 space-y-14">
              <div>
                ...
                <p className="text-base text-zinc-700">
                  Absolutely not! You'll only be charged when you choose to
              ...
              <div>
                ...
                <ul className="list-disc pl-5 text-base text-zinc-700 space-y-1">
                  ...
                  <li>
                    SMS credits for reservation, insurance expiry, and overdue
                    invoice reminders (optional, 10¢ per message).
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-base text-zinc-700">
                  No, you can cancel your subscription at any time and you won't
                  be billed again. We hope you will stick around because you
                  love using Harbr, not because we locked you into a contract.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-zinc-800 mb-1">
              ...
              <div>
                ...
                <p className="text-base text-zinc-700">
                  Contact us at{" "}
                  <a
                    href="mailto:chris@harbrapp.com"
